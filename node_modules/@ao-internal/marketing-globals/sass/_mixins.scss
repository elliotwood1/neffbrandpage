...
/**
 * Use in conjunction with https://www.npmjs.com/package/postcss-image-dimensions
 */
@mixin placeholderImage($path, $bgColour: true) {
	padding-bottom: image-height-ratio($path);

	@if ($bgColour) {
		background-color: image-color($path);
	}

	@media (min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
		padding-bottom: image-height-ratio-2x($path);
	}
}
